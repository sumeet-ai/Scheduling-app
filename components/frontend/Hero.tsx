...
const Hero = () => {
  return (
    ...
    <div className="relative  pb-[110px] pt-[120px] dark:bg-dark lg:pt-[50px] max-w-6xl mx-auto">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-5/12">
              <div className="hero-content">
                <h1 className="mb-5 text-white text-4xl font-bold !leading-[1.208] text-white  dark:text-white sm:text-[42px] lg:text-[40px] xl:text-5xl">
                  Kickstart Startup Website with TailGrids
                </h1>
                <p className="mb-8 text-white max-w-[480px] text-base text-body-color dark:text-dark-6">
                ...
                <ul className="flex flex-wrap items-center">
                  <li>
                    <a
                      href="/#"
                      className="inline-flex items-center justify-center rounded-md bg-blue-600 bg-primary px-6 py-3 text-center text-base font-medium text-white hover:bg-blue-700 lg:px-7"
                    >
                      Get Started
                    </a>
                  </li>
